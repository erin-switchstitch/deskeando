		...
		<div className="ConfirmationPageOuterWrapper">
			...
			<div className="ConfirmationPageInnerWrapper">
				...
				{globalBookingInfo.other_id > 0 ? (
					<ul>
						<li>
							Name : {globalBookingInfo.other_first_name}{" "}
							{globalBookingInfo.other_last_name}
						</li>
						<li>
							Date : {globalBookingInfo.date_booked} from {timings}
						</li>
					...
					<ul>
						<li>
							Name : {globalUserDetails.first_name}{" "}
							{globalUserDetails.last_name}
						</li>
						<li>
							Date : {globalBookingInfo.date_booked} from {timings}
						</li>
			...
			<div className="ConfirmationPageBottomWrapper">
				...
				<Link to={"/dashboard"}>
					<button className="ConfirmationPageBottomButton">
						View dashboard
					</button>
				</Link>
			</div>

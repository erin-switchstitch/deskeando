	...
	return (
		<div className="UppOuterWrapper">
			...
			<div className="UppFirstInnerWrapper">
				<h3>
					Please adjust the sliders below to update your accessibility settings
				</h3>
				<h4>
					Currently set to : "
					<strong>{globalUserDetails.accessibility.toString()}</strong>"
				</h4>
				...
				<FormGroup className="sliderWrapper">
					...
					<FormControlLabel
						onChange={(e) => sliderChange(e)}
						control={<Switch checked={sliderToggle} />}
						label="Low Noise Area"
						labelPlacement="start"
					/>
					<FormControlLabel
						onChange={(e) => sliderChange(e)}
						control={<Switch checked={sliderToggle} />}
						label="Close to Bathroom"
						labelPlacement="start"
					/>
					<FormControlLabel
						onChange={(e) => sliderChange(e)}
						control={<Switch checked={sliderToggle} />}
						label="Larger Desktop Screen"
						labelPlacement="start"
					/>
					<FormControlLabel
						onChange={(e) => sliderChange(e)}
